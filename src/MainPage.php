...
class MainPage
{
    ...
    private function execute($state)
    {
        ...
        if ($state == "calculate_from_strava" || $state == "calculate_from_mcl" || $state == "calculate_from_endo" || $state == "calculate_from_rwgps") {
            ...
            $str .= $this->deleteEndoRidesFromStrava();
...
//        $str .= $this->copyForm();
    ...
    <p>Click the buttons below to authorise access to your accounts.</p>
    <p><em>This website uses cookies to give you privacy.  None of your personal data is stored remotely,  all login details are 
    saved to cookies on
...
";
     ...
     * @return string
     */
    private function deleteEndoRidesFromStrava()
    {
        $str = "";
